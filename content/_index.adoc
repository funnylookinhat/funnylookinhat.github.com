...
** My goal for [.line-through]#2025# 2026 is to attend https://monktoberfest.com/[Monktoberfest]
...
* I currently am running https://system76.com/pop/[Pop OS (GNU/Linux)] as my daily driver.
** I haven't upgraded to COSMIC yet... I'll do that soon.  My mental model is
   pretty attached
   to having a grid of workspaces (3x3) and COSMIC only supports a horizontal
   or vertical layout of workspaces.
...
*** I'm not on IRC very frequently anymore - but when I do login, these are the
    channels that I tend to join and idle in.
*** #docker
*** #ubuntu
*** #solus
*** #node.js
